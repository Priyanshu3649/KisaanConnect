        ...
        <div className="space-y-2 text-sm">
            {lines.map((line, index) => {
                if (line.startsWith('**')) {
                    ...
                    return (
                        <div key={index} className="grid grid-cols-3 gap-2 py-1 border-b last:border-none">
...
export default function DiseaseDetectorPage() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            // The wrapper function handles extracting the base64 data
            ...
            await addDoc(collection(db, 'diagnoses'), {
                userId: user.uid,
                imageUrl: imageUrl,
                result: diagnosis.analysis, // Save the markdown string
